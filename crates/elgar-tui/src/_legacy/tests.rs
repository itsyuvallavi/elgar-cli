//! Legacy TUI test fixtures.
//!
//! Archived with the old tool/action UI tests. These are not the active raw-chat
//! verification path.
...
use super::{
    ...
    copy_conversation_with_clipboards, copy_raw_details_with_clipboards,
    copy_text_with_command_and_args, default_shell_text, encode_base64, handle_inline_submission,
