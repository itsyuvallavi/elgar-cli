        ...
        Self {
            tools: vec![
                ...
                PrimitiveTool {
                    ...
                    limits: &[
                        "requires explicit user approval",
                        "writes exact arguments.content",
                        "rejects symlink targets and symlink parent folders",
                    ],
                },
                PrimitiveTool {
                    id: PrimitiveToolId::Edit,
                    display_name: "Edit",
                    description: "Replace exact text in one existing file after policy approval.",
                    input_shape: r#"{"type":"structured_request","kind":"edit","reason":"short reason","arguments":{"path":"path/from/user.ext","old_text":"exact old text","new_text":"exact new text"}}"#,
                    side_effect_level: PrimitiveToolSideEffectLevel::Write,
                    enabled_in_stage: true,
                    executable_in_stage: false,
                    requires_permission: true,
