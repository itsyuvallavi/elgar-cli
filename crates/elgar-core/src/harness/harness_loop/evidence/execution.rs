...
pub(in crate::harness::harness_loop) fn execute_primitive_request(
    ...
    match request.kind {
        ...
        StructuredRequestKind::Write => super::side_effects::execute_policy_write(session, request),
        StructuredRequestKind::Bash => super::side_effects::execute_policy_bash(session, request),
        StructuredRequestKind::Edit => super::side_effects::execute_policy_edit(session, request),
