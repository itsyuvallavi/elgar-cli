//! Legacy reasoning trace rendering.
//!
//! Archived from the old session reasoning trace UI. Active provider reasoning
//! rendering lives under `panes/provider_reasoning.rs`.
